...
const Header: React.FC<HeaderProps> = ({ 
    ...
    onToggleSidebar, isDesktopSidebarOpen, onToggleDesktopSidebar
}) => {
    ...
    const menuStructure = [
        ...
        },
        {
            ...
            items: [
                ...
                { label: 'ระบบโภชนาการ', page: 'general_nutrition' as Page }
            ]
        },
        {
            key: 'studentAffairs',
                ...
                <div className="flex items-center gap-3">
                    ...
                    {onToggleDesktopSidebar && (
                        <button 
                            ...
                            className="hidden lg:flex items-center justify-center p-2 rounded-lg text-white hover:bg-white/20 transition-colors mr-1"
                            title={isDesktopSidebarOpen ? "ซ่อนเมนู" : "แสดงเมนู"}
                        >
