...
procurement_report: `
<div style="padding: 1.5cm 2cm; font-size: 16pt; line-height: 1.5;">
    <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 1rem;">
        ...
        <p style="font-weight: bold; padding-top: 0.5rem;">ที่..........................................</p>
    </div>
    ...
    <div style="font-size: 16pt; line-height: 1.7; margin-top: 1.5rem; space-y: 0.25rem;">
        ...
        <div style="display: flex; flex-wrap: wrap; align-items: baseline;">
            ...
            <span style="flex-grow: 1; border-bottom: 1px dotted black; padding: 0 0.5rem;">..................................................................................................</span> 
    ...
    <hr style="border-color: black; margin-top: 1rem; margin-bottom: 1rem;" />
    ...
    <table style="width: 100%; border-collapse: collapse; border: 1px solid black; text-align: center; font-size: 14pt; margin-top: 1rem;">
        <thead>
            <tr style="font-weight: bold;">
                <td class="border border-black p-1 w-12" rowspan="2">ลำดับที่</td>
                <td class="border border-black p-1" rowspan="2">รายการ พัสดุ / ซื้อ / จ้าง<br/>(ขนาด ยี่ห้อและคุณลักษณะชัดเจน)</td>
                <td class="border border-black p-1" colspan="2">ปริมาณ</td>
                <td class="border border-black p-1" colspan="2">ราคา</td>
                <td class="border border-black p-1 w-20" rowspan="2">หมายเหตุ</td>
            </tr>
            <tr style="font-weight: bold;">
                <td class="border border-black p-1 w-16">จำนวน</td>
                <td class="border border-black p-1 w-16">หน่วย</td>
                <td class="border border-black p-1 w-24">ต่อหน่วย</td>
                <td class="border border-black p-1 w-24">เป็นเงิน</td>
            </tr>
        </thead>
        <tbody>
            {{items_table_rows}}
        ...
        <tfoot>
            <tr><td colspan="2" class="border border-black p-1 text-left font-bold">(ส่วนลด 0.00 บาท จาก {{totalPrice}} บาท เหลือ {{totalPrice}} บาท) รวม</td><td colspan="3" class="border border-black p-1 font-bold">มูลค่าสินค้าก่อนคิด VAT</td><td class="border border-black p-1 text-right font-bold">{{totalPrice}}</td><td class="border border-black p-1"></td></tr>
            <tr><td colspan="2" class="border border-black p-1 text-left font-bold"></td><td colspan="3" class="border border-black p-1 font-bold">ภาษีมูลค่าเพิ่ม 0 %</td><td class="border border-black p-1 text-right font-bold">0.00</td><td class="border border-black p-1"></td></tr>
            <tr><td colspan="2" class="border border-black p-1 text-center font-bold">{{totalPriceWords}}</td><td colspan="3" class="border border-black p-1 font-bold">รวมทั้งสิ้น</td><td class="border border-black p-1 text-right font-bold">{{totalPrice}}</td><td class="border border-black p-1"></td></tr>
        </tfoot>
    </table>
    ...
    <div style="margin-top: 1rem; font-size: 16pt;">
        ...
        <div style="margin-left: 3rem;">
            ...
            <div style="display: flex; align-items: baseline; margin-top: 0.25rem;"><span style="width: 32px;">2.2</span> <span style="border-bottom: 1px dotted black; flex-grow: 1;">{{committeeMember1Name}}</span> <span style="width: 80px; margin-left: 0.5rem;">ตำแหน่ง</span> <span style="border-bottom: 1px dotted black; width: 192px;">กรรมการ</span></div>
            <div style="display: flex; align-items: baseline; margin-top: 0.25rem;"><span style="width: 32px;">2.3</span> <span style="border-bottom: 1px dotted black; flex-grow: 1;">{{committeeMember2Name}}</span> <span style="width: 80px; margin-left: 0.5rem;">ตำแหน่ง</span> <span style="border-bottom: 1px dotted black; width: 192px;">กรรมการ</span></div>
        </div>
    </div>
    ...
    <div style="margin-top: 2rem; font-size: 16pt; line-height: 1.2; display: flex; justify-content: space-between;">
        <div style="width: 50%; display: flex; flex-direction: column; justify-content: space-between; text-align: center;">
            <div><p>ลงชื่อ .......................................................</p><p style="margin-top: 0.5rem;">( {{requesterName}} )</p><p>เจ้าหน้าที่พัสดุ</p><p>กลุ่ม/งาน</p></div>
            <div><p>ลงชื่อ .......................................................</p><p style="margin-top: 0.5rem;">( {{procurementHeadName}} )</p><p>หัวหน้าเจ้าหน้าที่พัสดุ</p><p>โรงเรียน</p></div>
